...
export interface LoanContract {
  ...
  contract_status: 'active' | 'pending' | 'repaid' | 'defaulted'; // Current loan contract status
  ...
  ltv_ratio: number; // Initial Loan-to-value ratio from asset.maxLTV
