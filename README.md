...
## Charon API (Loan Contracts)

### Missing Fields in Loan Contract Response
```json
{
  "id": "668bc542-b148-4bde-a8b6-c245b056d954",
  "name": "Neel Ganu - Sep 10, 2025", //loan name
  "balanceOpen": 3600000,
...
- `GET /loans/{id}/interest-rate` - Get current interest rate information
- `GET /loans/{id}/next-payment` - Get next payment due information
- `GET /loans/{id}/documents` - Get associated loan documents
- `GET /loans/{id}/status` - Get detailed loan status information

## Eunomia API (Accounting/Ledger)

### Missing Fields in Ledger Entry Response
```json
{
  "id": "54",
  ...
  "amount": "36000.00",
  "description": "Loan disbursement - Contract 668bc542-b148-4bde-a8b6-c245b056d954",
  "user_id": "system-auto",
  "contract_id": "b6a1dffb-f448-4d34-8906-b182acef5b28",
  "timestamp": "2025-09-11T19:11:06.010502",

  // MISSING FIELDS:
  "entry_type": "disbursement", // disbursement, payment, fee, interest_accrual, etc.
  "category": "loan_principal", // loan_principal, interest, fee, etc.
  "is_loan_balance": true, // true for entries that affect loan balance
  "payment_method": null, // for payment entries
  "reference_number": null // for payment tracking
}
```
...
- `GET /contracts/{id}/fees` - Get all fees associated with the contract
- `GET /contracts/{id}/payments` - Get payment history (filtered from ledger)
- `GET /contracts/{id}/disbursements` - Get disbursement history
